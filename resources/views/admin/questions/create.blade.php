                    ...
                    <form action="{{ route('admin.questions.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            <label for="male_question"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">السؤال
                                للخاطب</label>
                            <textarea
                                required
                                class="block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                id="male_question" name="male_question" rows="3"></textarea>
                        </div>
                        <div class="mb-6">
                            ...
                            <textarea
                                required
                                class="block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                id="female_question" name="female_question" rows="3"></textarea>
                        </div>
                        <div class="mb-6">
                            <div class="mb-6">
